...
def main():
    ...
    valid_modes = ("ac_sign", "dc_bitplane", "hybrid", "split")
    inp_mode=input("Nhap mode (ac_sign/dc_bitplane/hybrid/split, mac dinh la hybrid):").strip() or "hybrid"
    ...
    runner.encode(input_path,output_base,key,key_id)
